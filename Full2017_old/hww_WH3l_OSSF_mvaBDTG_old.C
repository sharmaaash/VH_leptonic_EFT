...
myreaderBDTGOSSF->BookMVA("BDTG4","/afs/cern.ch/user/s/sharmaa/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/EFT/WH3l/BDT_analysis/BDT_config/WH3left_Full2017/datasetOSSF04Feb_MET/weights/TMVAClassification_BDTG4.weights.xml");
...
float hww_WH3l_OSSF_mvaBDTG(int entry, int nclass){
    ...
    float classifier = myreaderBDTGOSSF->EvaluateMVA("BDTG4");
