...
/afs/cern.ch/user/s/sharmaa/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/EFT/WH3l/BDT_analysis/BDT_config/v7
variables['BDTG_OSSF_10bin'] = { 'name': 'hww_WH3l_OSSF_mvaBDTG(Entry$,0)',
                        'range' : (10,-1,1),
                        'xaxis' : 'MVA discriminant',
                        'fold' : 3,
                        'linesToAdd' : ['.L %s/src/PlotsConfigurations/Configurations/EFT/WH3l/FullRun2/hww_WH3l_OSSF_mvaBDTG.C+' % os.getenv('CMSSW_BASE')] 
                       }
