...
myreaderBDTGOSSF->BookMVA("BDTG4F07D31C2","/afs/cern.ch/user/s/sharmaa/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/EFT/WH3l/BDT_analysis/BDT_config/WH3left_combined/datasetOSSF22jul_MET/weights/TMVAClassification_BDTG4F07.weights.xml");
