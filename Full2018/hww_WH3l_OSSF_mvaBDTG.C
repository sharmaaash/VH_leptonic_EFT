...
myreaderBDTGOSSF->BookMVA("BDTG4F07","/afs/cern.ch/user/s/sharmaa/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/EFT/WH3l/BDT_analysis/BDT_config/v7/WH3left_Full2018/datasetOSSF04Feb_MET/weights/TMVAClassification_BDTG4F07.weights.xml");
}
